...
import (
	...
	"shop_web/order_web/initialize"
	"shop_web/order_web/utils"
	"shop_web/order_web/utils/register/consul"
	myValidator "shop_web/order_web/validator"
	"syscall"
)
...
func main() {
	...
	if err := registerClient.DeRegister(serviceId); err != nil{
		zap.S().Panic("注销订单服务失败：", err.Error())
	}else {
		zap.S().Infof("注销订单服务成功")
	}
