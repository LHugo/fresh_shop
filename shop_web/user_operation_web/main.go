...
import (
	...
	"shop_web/user_operation_web/initialize"
	"shop_web/user_operation_web/utils"
	"shop_web/user_operation_web/utils/register/consul"
	myValidator "shop_web/user_operation_web/validator"
	"syscall"
)
...
func main() {
	...
	if err := registerClient.DeRegister(serviceId); err != nil{
		zap.S().Panic("注销用户操作服务失败：", err.Error())
	}else {
		zap.S().Infof("注销用户操作服务成功")
	}
