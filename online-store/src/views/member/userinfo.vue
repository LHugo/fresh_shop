            ...
            <div width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
              <div>
                <div class="table-box">
                  ...
                  <div width="72%" align="left" class="label-input" bgcolor="#FFFFFF"><input name="email" class="input-phone inputBg" type="text" placeholder="" size="25" v-model="userInfo.name">
                  </div>
                </div>
                <div class="table-box">
