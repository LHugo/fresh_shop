              ...
              <table width="100%" border="0" cellpadding="3">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <label for="one">反馈</label>
                    <input type="radio" id="two" value="2" v-model="type">
                    <label for="two">投诉</label>
                    <input type="radio" id="three" value="3" v-model="type">
                    <label for="three">询问</label>
                    <input type="radio" id="four" value="4" v-model="type">
                    <label for="four">售后</label>
                    <input type="radio" id="five" value="5" v-model="type">
                ...
                <tr>
                  ...
                  <td><textarea name="msg_content" cols="50" rows="4" wrap="virtual" class="B_blue"
                                v-model="text"></textarea></td>
                </tr>
                <tr>
                  <td align="right">上传文件：</td>
                  <td><input type="file" name="message_img" size="45" class="inputBg-upload input-box"
                             @change="preview"></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
...
export default {
  ...
  methods: {
    ...
    uploadFile(url, param, file_name) { //上传文件
