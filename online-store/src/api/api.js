...
let baseUrl = "http://192.168.23.1:8000"
let goodsUrl = "http://192.168.23.1:8022"
let orderUrl = "http://192.168.23.1:8023"
let userUrl = "http://192.168.23.1:8021"
let userOpUrl = "http://192.168.23.1:8027"
let ossUrl = "http://192.168.23.1:8029"

//上传文件
export const upload = (url,params) => { return axios.post(url,params)}

//登录
export const login = params => { return axios.post(`${userUrl}/u/v1/user/pwd_login`, params)}
//注册
...
//获取验证码
export function getCaptcha(params) { return axios.get(userUrl+'/u/v1/base/captcha')}
...
//收藏
export const addFav = params => { return axios.post(`${userOpUrl}/up/v1/favs`, params) }
//取消收藏
export const delFav = goodsId => { return axios.delete(`${userOpUrl}/up/v1/favs/`+goodsId) }
//获取全部收藏列表
export const getAllFavs = () => { return axios.get(`${userOpUrl}/up/v1/favs`) }
//判断是否收藏getAllFavs
export const getFav = goodsId => { return axios.get(`${userOpUrl}/up/v1/favs/`+goodsId) }
