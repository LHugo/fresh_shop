    ...
    methods: {
      ...
      getList() {
        ...
        getOrder(this.listQuery).then(response => {
          ...
          this.offset = this.listQuery.offset
          this.listQuery.offset = response.data.length==this.listQuery.limit?this.listQuery.offset+1:this.listQuery.offset
        });
      },
      deleteOrder(ids){
