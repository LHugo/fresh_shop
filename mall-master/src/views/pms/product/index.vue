  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="goodsParams" size="small" label-width="140px">
          <el-form-item label="输入搜索：">
            <el-input style="width: 203px" v-model="goodsParams.keywords" placeholder="商品名称"></el-input>
          </el-form-item>
          <el-form-item label="商品分类：">
            <el-cascader
              clearable
              v-model="goodsParams.cd"
              @change="getBrand"
    ...
    <div class="pagination-container">
      <el-pagination
        ...
        :current-page.sync="goodsParams.offset"
        :total="total">
        <!-- :page-sizes="[5,10,15]" -->
      </el-pagination>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleSearchEditSku(){
        fetchSkuStockList(this.editSkuInfo.productId,{keywords:this.editSkuInfo.keywords}).then(response=>{
      ...
      handleSizeChange(val) {
        this.goodsParams.offset = 1;
        this.goodsParams.limit = val;
        this.getList();
      },
      handleCurrentChange(val) {
        this.goodsParams.offset = val;
        this.getList();
      },
