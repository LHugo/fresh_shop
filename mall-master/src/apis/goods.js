...
export let ossUrl = "http://192.168.23.1:8029"
...
export function deleteBrand(id,params) {
  return request({
    url:goodsUrl+'/g/v1/brands/'+id,
    method:'delete',
    data:params
...
export function putMessage(id,params) {
  return request({
    url:userOpUrl+'/up/v1/messages/'+id,
    method:'put',
    data:params
  })
}
...
export function putaddress(id,params) {
  return request({
    url:userOpUrl+'/up/v1/address/'+id,
    method:'put',
    data:params
  })
}
