...
class Category(BaseModel):
    ...
    is_tab = BooleanField(default=False, verbose_name="是否展示在首页分类目录")
...
class Goods(BaseModel):
    ...
    transport_free = BooleanField(default=True, verbose_name="是否承担运费")
...
class GoodsCategoryBrand(BaseModel):
    ...
    category_id = ForeignKeyField(Category, verbose_name="类别")
    brand_id = ForeignKeyField(Brands, verbose_name="品牌")
